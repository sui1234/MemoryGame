...
public class Activity6 extends AppCompatActivity {
    ...
    public void checkCard() {
        ...
        if (showImage1.getVisibility() == View.INVISIBLE
            ...
            AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(Activity6.this);

            LayoutInflater factory = LayoutInflater.from(Activity6.this);
